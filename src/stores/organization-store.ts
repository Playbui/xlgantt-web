  ...
  persist(
    (set, get) => ({
      ...
      addCompany: async (input) => {
        ...
        if (error) console.warn('회사 저장 실패:', error.message)
      },
      ...
      addDepartment: async (input) => {
        ...
        if (error) console.warn('부서 저장 실패:', error.message)
      },
      ...
      addTeam: async (input) => {
        ...
        if (error) console.warn('팀 저장 실패:', error.message)
      },
      ...
      assignUser: async (userId, value) => {
        ...
        if (error) console.warn('사용자 조직 지정 실패:', error.message)
      },
